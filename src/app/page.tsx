...
const li =
  "border-b-4 border-transparent hover:border-b-4 hover:border-blue-500 ";
export default function Home() {
  const { theme, setTheme } = useTheme();
  return (
    <div
      suppressHydrationWarning={true}
      className="w-full  flex flex-col min-h-[100%] h-auto dark:bg-slate-900 bg-gray-100 text-black dark:text-white"
    >
      <header className="w-full flex justify-between  md:justify-center items-center ">
        ...
        <nav className="sm:m-auto">
          <ul className="hidden sm:flex gap-2 md:gap-4 lg:gap-8 text-md font-semibold mr-10">
            <li className={li}>
              <Link href={links[0]}>Features</Link>
            </li>
            <li className={li}>
              <Link href={links[1]}>Desktop App</Link>
            </li>
            <li className={li}>
              <Link href={links[2]}>Privacy & Safety</Link>
            </li>
            <li className={li}>
              <Link href={links[3]}>For Developers</Link>
            </li>
          </ul>
      ...
      <main className=" bg-gray-200 dark:bg-slate-800 flex-1 flex flex-col md:flex-row p-5 justify-center md:h-screen items-center h-auto  gap-12 min-h-[786px]">
        <div className="h-full max-w-[500px] flex flex-col">
          <div>
            ...
            <h2 className="text-center md:text-start text-2xl  tracking-tight dark:text-gray-200 text-gray-900 hidden md:block">
      ...
      <footer className="dark:bg-slate-900 relative w-full bg-white h-20 min-h-12 justify-center items-center gap-5 hidden md:flex text-sm z-50">
        <div className="w-auto font-bold">© Meta 2024.</div>
        <div>
