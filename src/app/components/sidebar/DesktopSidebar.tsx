...
const DesktopSidebar:React.FC<DesktopSidebarProps>=({currentUser})=> {
      ...
      <div className='hidden md:fixed lg:inset-y-0 lg:left-0 lg:z-40 lg:w-20 xl:px-6 lg:overflow-y-auto lg:bg-white lg:border-r-[1px] lg:pb-4 lg:flex lg:flex-col z-0 justify-between'>
