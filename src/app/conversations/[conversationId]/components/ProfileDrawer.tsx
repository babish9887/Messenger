                                                      ...
                                                      <div className='flex flex-col items-center'>
                                                            ...
                                                            {data.isGroup?(
                                                             ...
                                                             <div className='relative'>
                                                                  <div className='relative inline-block rounded-full overflow-hidden w-32 h-32'>
                                                                        {/* <Image src={user?.image || placeholder} alt='avatar' fill/> */}
                                                                        <Image src={otherUser?.image ? otherUser.image : placeholder} alt='Avatar' fill/>
                                                                  </div>
                                                                  {isActive &&
                                                                  <span className='absolute block rounded-full bg-green-500 ring-4 ring-white bottom-2 right-2 h-6 w-6'/>
                                                                  }
                                                            </div>
                                                            )}
                                                            </div>
                                                            ...
                                                            <div className='w-full pb-5 pt-5 sm:px-0 sm:pt-0'>
                                                                  <dl className='space-y-8 px-4 sm:space-y-6 sm:px-6'>
                                                                        ...
                                                                        <div className='w-full flex justify-between hover:cursor-pointer font-semibold' onClick={()=>setMediaBox(!mediaBox)}>
                                                                              Media and Files
